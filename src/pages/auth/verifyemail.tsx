...
import { emailVerify } from "@/http/auth";
...
export function Verify_Email() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      const otpdata = data.data.data;
      dispatch(setOTP(otpdata));

      import.meta.env.VITE_NODE_ENV === "development"
        ? console.log(otpdata)
        : "";
      toast("Send Otp Successfully.", "Check your inbox for otp", "success");
    },
    onError: (err: any) => {
    ...
    <Form {...form}>
      <div className="w-full mt-2 lg:grid lg:min-h-[200px] lg:grid-cols-2 xl:min-h-[800px] bg-bluchp">
        <div className="flex items-start justify-center ">
          <div className="mt-4 grid w-[350px] gap-6 ">
